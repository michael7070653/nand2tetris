...
class JackTokenizer:
    ...
    KEYWORD_ARR = {'class':"CLASS",
               ...
               'void':"VOID", 'true':"TRUE", 
               'false': "FALSE", 'null':"NULL",  'this':"THIS", 'let':"LET", 'do':"DO",
               'if':"IF", 'else':"ELSE", 
    ...
    def get_token(self):
        ...
        if command_type == "KEYWORD":
            return self.keyword()
        elif command_type == "SYMBOL":
            return self.symbol()
        elif command_type == "IDENTIFIER":
            return self.identifier()
        elif command_type == "INT_CONST":
            return self.int_val()
        elif command_type == "STRING_CONST":
            return self.string_val()
        else:
            return None
        # if command_type == "SYMBOL":
        #     return self.symbol()
        # return self.cur_command
